import 'package:firebasetest/hesaplama.dart';
...
class _FireState extends State<Fire> {
  ...
  void dispose() {
    // dispose işlemleri
    siyezYanikController.dispose();
    siyezParcalandiController.dispose();
    siyezPismediController.dispose();
    tambugdayYanikController.dispose();
    tambugdayParcalandiController.dispose();
    tambugdayPismediController.dispose();
    cavdarYanikController.dispose();
    cavdarParcalandiController.dispose();
    cavdarPismediController.dispose();
    super.dispose();
  }
}
